...
# set paths
rootpath = '../data/CUB_200_2011/'
imgspath = rootpath + 'images/'
trainpath = '../data/CUB_200_2011/datasets/cub200_cropped/train_cropped/'
testpath = '../data/CUB_200_2011/datasets/cub200_cropped/test_cropped/'
...
for i in range(11788):
    ...
    print('{} imgs cropped and saved to path: {}.'.format(i + 1, imgspath + names[i][1]))
print('All Done.')
